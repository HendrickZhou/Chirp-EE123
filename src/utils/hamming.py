# Original author: vatsal-sodha
# Modified by James Dalton (jamesldalton) to work with bitarray
# 5/4/2019
...
# tx_data = hammingCodes(data.tolist())
# print("tx_data: " + str(tx_data))

# # corrupt the data
# rx_data = tx_data
# rx_data[7] = not rx_data[7]
# print("rx_data (error): " + str(rx_data))

# # correct the error
# rx_data_corrected = hammingCorrection(rx_data.tolist())
# print("data (corrected): " + str(rx_data_corrected))
############################################################
